...
public class TextGlow extends TextView{
	//Variable a utilizar
	private ArrayList<Shadow> outerShadows,innerShadows;
	...
	private float strokeWidth,strokeMiter;
	...
	public TextGlow(Context context){
		super(context);
		init(null);
	}
	
	public TextGlow(Context context,AttributeSet attrs){
		super(context,attrs);
		init(attrs);
	}
	
	public TextGlow(Context context,AttributeSet attrs,int defStyle){
		super(context,attrs,defStyle);
		init(attrs);
	}
	
	//Proceso que asigna la fuente y los efectos
	...
	//Método que dibuja on objeto Canvas
	...
	//Método que genera un Canvas temporal porqué no se puede guardar
	...
	//Bloquea esto mientras el onDraw está en proceso
	public void freeze(){
	...
	//Desbloquea esto mientras el onDraw está en proceso
	public void unfreeze(){
		frozen=false;
	}
	
	//Asignamos el layout y funciones
	@Override
